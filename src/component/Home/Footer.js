...
const Footer = () => {
    return (
        <footer style={{ backgroundColor: '#6F9A61', width: '100%', height: '400px', overflow: 'hidden', padding: '25px 0', marginTop: '50px', color: 'aliceblue' }}>
                ...
                <div className="row">
                    ...
                    <div className="col-md-3 col-sm-6">
                        ...
                        <ul style={{ listStyle: 'none', marginLeft: '34px' }} className="ulfooter">
                            ...
                            <li>  <Link to="npm star/Contact" >Contact Us</Link></li>
                        </ul>
                    </div>
                    <div className="col-md-3 col-sm-6">
